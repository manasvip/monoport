...
// Comments form.
add_filter( 'comment_form_default_fields', 'monoport_bootstrap_comment_form_fields' );
...
if ( ! function_exists( 'monoport_bootstrap_comment_form_fields' ) ) {

	function monoport_bootstrap_comment_form_fields( $fields ) {
		...
		$fields    = array(
			'author'  => '<div class="form-group comment-form-author"><label for="author">' . __( 'Name',
					'monoport' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
...
} // endif function_exists( 'monoport_bootstrap_comment_form_fields' )

add_filter( 'comment_form_defaults', 'monoport_bootstrap_comment_form' );
...
if ( ! function_exists( 'monoport_bootstrap_comment_form' ) ) {

	function monoport_bootstrap_comment_form( $args ) {
		$args['comment_field'] = '<div class="form-group comment-form-comment">
	    <label for="comment">' . _x( 'Comment', 'noun', 'monoport' ) . ( ' <span class="required">*</span>' ) . '</label>
	    <textarea class="form-control" id="comment" name="comment" aria-required="true" cols="45" rows="8"></textarea>
	    </div>';
		$args['class_submit']  = 'btn btn-secondary'; // since WP 4.1.
		return $args;
	}
} // endif function_exists( 'monoport_bootstrap_comment_form' )
