...
Start talking: [![Gitter](https://img.shields.io/gitter/room/holger1411/monoport.svg?maxAge=2592000?style=flat-square)](https://gitter.im/holger1411/monoport)

## About

I’m a huge fan of Underscores, Bootstrap, and Sass. Why not combine these into a solid WordPress Theme Framework?
That’s what monoport is. 
You can use it as starter theme and build your own theme on top of it. Or you use it as parent theme and create your own child theme for monoport.

At the moment, monoport is in a very early stage. But if you want, feel free to use it for your own WordPress theme!

# monoport WordPress Theme Framework

Website: [http://monoport.com](http://monoport.com)

Child Theme Project: [https://github.com/holger1411/monoport-child](https://github.com/holger1411/monoport-child)
...
- The `/css/theme.css` and it´s minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
                  ...
                  - 1 "theme/theme_variables";  // <--------- Add your variables into this file. Also add variables to overwrite Bootstrap or monoport variables here
                  - 2 "../src/bootstrap-sass/assets/stylesheets/bootstrap";  // <--------- All the Bootstrap stuff - Don´t edit this!
                  - 3 "monoport/monoport"; // <--------- Some basic WordPress stylings and needed styles to combine Boostrap and Underscores
...
- Download the monoport folder from GitHub or from monoport.com
